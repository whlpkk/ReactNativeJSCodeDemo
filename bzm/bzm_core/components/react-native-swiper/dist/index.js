...
module.exports = _reactNative2.default.createClass({
  ...
  initState: function initState(props) {
    ...
    initState.offset = {};
    initState.scrollContentOffsetX = 0;
...
onScrollEndDrag:function onScrollEndDrag(e){
  var _this2 = this;
  _this2.props.onScrollEndDrag &&_this2.props.onScrollEndDrag(e,_this2.state);
},
  /**
   * Scroll end handle
   * @param  {object} e native event
  ...
  injectState: function injectState(props) {
    ...
    for (var prop in props) {
      ...
      if (typeof props[prop] === 'function' && prop !== 'onMomentumScrollEnd' && prop !== 'renderPagination' && prop !== 'onScrollBeginDrag' && prop !== 'onScrollEndDrag') {
        (function () {
